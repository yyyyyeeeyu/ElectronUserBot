...
def user_input():
    ...
    if object_check["config_file"] != "":
        ...
        parser.add_argument(
            "-k", "--keywords", help="sınırlandırılmış liste girişi", type=str, required=False
        )
        parser.add_argument(
            "-kf",
            "--keywords_from_file",
            help="bir metin dosyasından anahtar kelimelerin listesini çıkar",
            type=str,
            required=False,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "-pk",
            "--prefix_keywords",
            help="ana anahtar kelimeden önce eklenen virgülle ayrılmış ek kelimeler",
            type=str,
            required=False,
        )
        parser.add_argument(
            "-l", "--limit", help="sınırlandırılmış liste girişi", type=str, required=False
        )
        parser.add_argument(
            "-f",
            "--format",
            help="görüntüleri belirli bir formatta indirin",
            type=str,
            required=False,
            choices=["jpg", "gif", "png", "bmp", "svg", "webp", "ico"],
        )
        parser.add_argument(
            "-u", "--url", help="google görsel URL'si ile arama", type=str, required=False
        )
        parser.add_argument(
            "-x",
            "--single_image",
            help="URL'den tek bir resim indirme",
            type=str,
            required=False,
        )
        parser.add_argument(
            "-o",
            "--output_directory",
            help="görüntüleri belirli bir ana dizine indir",
            type=str,
            required=False,
        )
        parser.add_argument(
            "-i",
            "--image_directory",
            help="görüntüleri belirli bir alt dizine indir",
            type=str,
            required=False,
        )
        parser.add_argument(
            ...
            "--no_directory",
            default=False,
            help="görüntüleri ana dizine indir, ancak alt dizini yok",
            action="store_true",
        )
        parser.add_argument(
            "-d",
            "--delay",
            help="iki görüntünün indirilmesi arasında beklemek için saniye cinsinden gecikme",
            type=int,
            required=False,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "-es",
            "--exact_size",
            help='tam görüntü çözünürlüğü "GENİŞLİK, YÜKSEKLİK"',
            type=str,
            required=False,
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "-wr",
            "--time_range",
            help='görüntünün yaşı için zaman aralığı. {"time_min":"MM/DD/YYYY","time_maks":"MM/DD/YYYY"} biçiminde olmalıdır',
            type=str,
            required=False,
        )
        parser.add_argument(
            "-a",
            "--aspect_ratio",
            help="Anahtar kelimelere eklenen virgülle ayrılmış ek kelimeler",
            type=str,
            required=False,
        ...
        parser.add_argument(
            "-si",
            "--similar_images",
            help="sağladığınız resim URL'sine çok benzeyen resimleri indirir",
            type=str,
            required=False,
        )
        parser.add_argument(
            "-ss",
            "--specific_site",
            help="belirli bir web sitesinden dizine eklenen resimleri indirir",
            type=str,
            required=False,
        )
        parser.add_argument(
            ...
            "--print_urls",
            default=False,
            help="Resimlerin URL'lerini yazdırın",
            action="store_true",
        )
        parser.add_argument(
            "-ps",
