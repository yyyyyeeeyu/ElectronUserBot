...
@electron_on_cmd(
    ["autopost"],
    cmd_help={
        "help": "Otomatik Gönderi Listesine Kanal Ekle!",
        "example": "{ch}autopost @ElectronUserBot",
    },
    chnnl_only=True,
)
async def autopost(client, message):
    engine = message.Engine
    mess_age_ = await edit_or_reply(message, engine.get_string("İŞLENİYOR"))
...
@electron_on_cmd(
    ["rmautopost"],
    cmd_help={
        "help": "Otomatik Gönderi Listesinden Bir Kanalı Kaldır.",
        "example": "{ch}rmautopost @ElectronUserBot",
    },
    chnnl_only=True,
)
