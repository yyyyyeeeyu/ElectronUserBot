...
def generate_meme(
    ...
    """Profesyoneller Gibi Memeler Yapın"""
...
async def convert_to_image(message, client) -> [None, str]:
    """Çoğu Medya Formatını Ham Görüntüye Dönüştür"""
    if not message:
        return None
...
async def convert_vid_to_vidnote(input_vid: str, final_path: str):
    """ Videoyu Video Notuna Dönüştür (Yuvarlak) """
...
async def convert_image_to_image_note(input_path):
    ...
    img_path = 'converted_by_ElectronUB.webp'
...
def extract_w_h(file):
    """ Videonun Genişliğini ve Yüksekliğini Çıkarın """
    command_to_run = [
        "ffprobe",
        "-v",
        "quiet",
