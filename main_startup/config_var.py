...
class Config((object)):
    ...
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC", "https://telegra.ph/file/d39aa3b0bd26b6d8cef3e.jpg"
    )
    ...
    TZ = os.environ.get("TZ", "Europe/İstanbul")
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/AnossaTG/ElectronUserBot"
    )
    ALIVE_IMG = os.environ.get(
        "ALIVE_IMG", "https://telegra.ph/file/7380b32f733ad7b25b5a5.jpg"
    )
    U_BRANCH = "master"
    ...
    USERBOT_LANG = os.environ.get("USERBOT_LANG", "tr")
    XTRA_PLUGINS_REPO = os.environ.get("XTRA_PLUGINS_REPO", "https://github.com/AnossaTG/Xtra-Plugins")
